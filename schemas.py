...
class ContactMessage(BaseModel):
    ...
    phone: Optional[str] = Field(None, max_length=25, description="Phone number")
    ...
    source: Optional[str] = Field(None, description="Where the message was submitted from (e.g., hero, contact page)")
